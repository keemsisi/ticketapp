...
public class JobAdvertisementController {
    ...
    public ResponseEntity<GenericApiResponse<JobAdvertisement>> create(@Validated @RequestBody CreateJobAdvertisementRequest request) throws Exception {
    ...
    public ResponseEntity<GenericApiResponse<JobAdvertisement>> getById(final @PathVariable UUID id) {
    ...
    public ResponseEntity<GenericApiResponse<JobAdvertisement>> deleteById(final @PathVariable UUID id) {
        service.delete(id);
        return ResponseEntity.ok().body(new GenericApiResponse<>("00", "Successfully deleted resource!", null));
    }

    @RequestMapping(method = RequestMethod.PATCH, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<GenericApiResponse<JobAdvertisement>> update(final @RequestBody UpdateJobAdvertisementRequest request) {
