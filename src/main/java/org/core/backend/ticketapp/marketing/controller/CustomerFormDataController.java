...
public class CustomerFormDataController {
    ...
    public ResponseEntity<GenericApiResponse<CustomerFormData>> create(@Validated @RequestBody CreateCustomerFormDataRequest request) throws Exception {
    ...
    public ResponseEntity<GenericApiResponse<CustomerFormData>> getById(final @PathVariable UUID id) {
    ...
    public ResponseEntity<GenericApiResponse<CustomerFormData>> update(final @RequestBody UpdateCustomerFormDataRequest request) {
