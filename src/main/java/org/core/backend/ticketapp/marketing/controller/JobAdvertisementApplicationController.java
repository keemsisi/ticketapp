...
public class JobAdvertisementApplicationController {
    ...
    public ResponseEntity<GenericResponse<JobAdvertisementApplication>> create(@Validated @RequestBody CreateJobAdvertisementApplicationRequest request) throws Exception {
    ...
    public ResponseEntity<GenericResponse<JobAdvertisementApplication>> getById(final @PathVariable UUID id) {
    ...
    public ResponseEntity<GenericResponse<JobAdvertisementApplication>> deleteById(final @PathVariable UUID id) {
        service.delete(id);
        return ResponseEntity.ok().body(new GenericResponse<>("00", "Successfully deleted resource!", null));
    }

    @RequestMapping(method = RequestMethod.PATCH, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<GenericResponse<JobAdvertisementApplication>> update(final @RequestBody UpdateJobAdvertisementApplicationRequest request) {
