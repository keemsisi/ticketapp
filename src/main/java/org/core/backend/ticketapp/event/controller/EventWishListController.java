...
public record EventWishListController(EventWishListService eventWishListService) implements ICrudController {
    ...
    public ResponseEntity<GenericApiResponse<EventWishList>> create(@RequestBody CreateEventWishListDTO request) {
        return ResponseEntity.ok(new GenericApiResponse<>("00", "Created Successfully", eventWishListService.create(request)));
    }
    ...
    public ResponseEntity<?> getById(@PathVariable UUID id) {
        return ResponseEntity.ok(new GenericApiResponse<>("00", "Fetched Successfully", eventWishListService.getById(id)));
    }
    ...
    public ResponseEntity<?> getAll(Pageable pageable) {
        ...
        return ResponseEntity.ok(
                new GenericApiResponse<>("00", "Fetched Successfully", response));
    }
