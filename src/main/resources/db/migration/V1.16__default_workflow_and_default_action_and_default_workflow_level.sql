...
-- create default role
INSERT INTO role
(id, code, created_by, created_on, description, is_deleted, modified_by, modified_on, "name", normalized_name, registrar_id)
VALUES('75d98a27-ed55-4bee-b385-e8e9e8600060'::uuid, 'role.default', '8b48d8c2-38ff-4f44-957b-47bdad8988d8'::uuid, CURRENT_TIMESTAMP, 'default role', false, NULL, NULL, 'default role', 'defaultrole', NULL);
-- Create default action

INSERT INTO action(id, module_id,name,normalized_name , code , description, created_on, modified_on, created_by, modified_by, is_deleted)
VALUES ('7d837372-1891-48c1-bc60-5b8a46655d8b'::uuid, '12a46804-5653-4b81-bdf4-87f5d259abdc'::uuid ,'DEFAULT ACTION', 'DEFAULT_ACTION', 'default.action' , 'Default Action', CURRENT_TIMESTAMP , NULL, '8b48d8c2-38ff-4f44-957b-47bdad8988d8'::uuid, NULL, false );
